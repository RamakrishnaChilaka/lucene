...
final class PanamaVectorUtilSupport implements VectorUtilSupport {
  ...
  private static final VectorSpecies<Integer> INT_FOR_FLOAT_SPECIES =
  ...
  public int filterByScore(
    ...
    if (Constants.HAS_FAST_COMPRESS_MASK_CAST) {
      for (int bound = FLOAT_SPECIES.loopBound(upTo); i < bound; i += FLOAT_SPECIES.length()) {
        ...
        IntVector docVector = IntVector.fromArray(INT_FOR_FLOAT_SPECIES, docBuffer, i);
        ...
        docVector.compress(mask.cast(INT_FOR_FLOAT_SPECIES)).intoArray(docBuffer, newUpto);
